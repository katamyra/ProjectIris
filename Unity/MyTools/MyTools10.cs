...
namespace Data
{
    public static class MyTools10
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime10U");
            finaltime = PlayerPrefs.GetString("ReactionTime10F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager10.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
