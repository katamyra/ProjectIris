...
namespace Data
{
    public static class MyTools12
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime12U");
            finaltime = PlayerPrefs.GetString("ReactionTime12F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager12.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
