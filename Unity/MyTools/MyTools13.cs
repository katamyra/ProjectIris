...
namespace Data
{
    public static class MyTools13
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime13U");
            finaltime = PlayerPrefs.GetString("ReactionTime13F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager13.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
