...
namespace Data
{
    public static class MyTools14
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime14U");
            finaltime = PlayerPrefs.GetString("ReactionTime14F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager14.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
