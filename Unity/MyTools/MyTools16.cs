...
namespace Data
{
    public static class MyTools16
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime16U");
            finaltime = PlayerPrefs.GetString("ReactionTime16F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager16.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
