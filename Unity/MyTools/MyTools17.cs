...
namespace Data
{
    public static class MyTools17
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime17U");
            finaltime = PlayerPrefs.GetString("ReactionTime17F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager17.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
