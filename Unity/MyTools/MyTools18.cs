...
namespace Data
{
    public static class MyTools18
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime18U");
            finaltime = PlayerPrefs.GetString("ReactionTime18F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager18.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
