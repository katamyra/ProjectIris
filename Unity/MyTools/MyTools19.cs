...
namespace Data
{
    public static class MyTools19
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime19U");
            finaltime = PlayerPrefs.GetString("ReactionTime19F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager19.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
