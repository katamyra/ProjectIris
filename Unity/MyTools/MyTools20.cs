...
namespace Data
{
    public static class MyTools20
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime20U");
            finaltime = PlayerPrefs.GetString("ReactionTime20F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager20.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
