...
namespace Data
{
    public static class MyTools21
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime21U");
            finaltime = PlayerPrefs.GetString("ReactionTime21F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager21.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
