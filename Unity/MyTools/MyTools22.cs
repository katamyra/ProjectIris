...
namespace Data
{
    public static class MyTools22
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime22U");
            finaltime = PlayerPrefs.GetString("ReactionTime22F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager22.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
