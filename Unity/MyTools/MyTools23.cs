...
namespace Data
{
    public static class MyTools23
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime23U");
            finaltime = PlayerPrefs.GetString("ReactionTime23F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager23.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
