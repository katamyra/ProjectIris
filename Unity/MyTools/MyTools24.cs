...
namespace Data
{
    public static class MyTools24
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime24U");
            finaltime = PlayerPrefs.GetString("ReactionTime24F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager24.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
