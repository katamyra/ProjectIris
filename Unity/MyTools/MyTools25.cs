...
namespace Data
{
    public static class MyTools25
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime25U");
            finaltime = PlayerPrefs.GetString("ReactionTime25F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();
            
            CSVManager25.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
