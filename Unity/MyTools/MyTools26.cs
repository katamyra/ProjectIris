...
namespace Data
{
    public static class MyTools26
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime26U");
            finaltime = PlayerPrefs.GetString("ReactionTime26F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager26.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
