...
namespace Data
{
    public static class MyTools27
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime27U");
            finaltime = PlayerPrefs.GetString("ReactionTime27F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager27.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
