...
namespace Data
{
    public static class MyTools28
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime28U");
            finaltime = PlayerPrefs.GetString("ReactionTime28F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager28.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
