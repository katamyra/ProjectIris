...
namespace Data
{
    public static class MyTools30
    {
        ...
        public static void DEV_AppendDefaultsToReport()
        {
            ...
            updatedtime = PlayerPrefs.GetString("ReactionTime30U");
            finaltime = PlayerPrefs.GetString("ReactionTime30F");
            GazePoint gazePoint = TobiiAPI.GetGazePoint();
            HeadPose headPose = TobiiAPI.GetHeadPose();

            CSVManager30.AppendToReport(
                    new string[20] {
                trial,
                lane,
                Name,
